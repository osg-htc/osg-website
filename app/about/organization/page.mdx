export const metadata = { title: "Members of the OSG Consortium — OSG Consortium" };
...
*The OSG Team operates the [Open Science Pool (OSPool)](/services/ospool/)* for use by research projects 
