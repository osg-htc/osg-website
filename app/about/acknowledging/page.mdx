export const metadata = { title: "Acknowledging the OSG — OSG Consortium" };
...
For your convenience, [a BibTex file containing the above four references](/osg.bib) has been provided.
