export const metadata = { title: "Google Groups - Managing List Membership — OSG Consortium" };
...
![Arrow pointing to Join Groups Button in Google Groups UI](/images/Google_Group_Join_UI.png)
